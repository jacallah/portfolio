        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/jack.jpg)'}} />
              <h1 id="colorlib-logo"><a href="index.html">Jack Callahan</a></h1>
              <span className="email"><i className="icon-mail"></i> jackcallaha00@gmail.com </span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/john-jack-callahan-562316174/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
            ...
            <div className="colorlib-footer">
              <p><small>
                  Made with brain power <i className="icon-heart" aria-hidden="true" /> <br></br>
